...
NM.mapdata = {
  ...
  itemtypes: {
    Junior4x4:      { pivotx: 0, pivoty : 0, scale: 0.5, name: 'red' },
    Kos4x4:         { pivotx: 0, pivoty : 0, scale: 0.5, name: 'lightblue' },
    Snuffel4x4:     { pivotx: 0, pivoty : 0, scale: 0.5, name: 'green' },
    Opvoedkunde4x4: { pivotx: 0, pivoty : 0, scale: 0.5, name: 'peach' },
    Tema4x4:        { pivotx: 0, pivoty : 0, scale: 0.5, name: 'yellow' },
    Maker4x4:       { pivotx: 0, pivoty : 0, scale: 0.5, name: 'purple' },
    Vermaak4x4:     { pivotx: 0, pivoty : 0, scale: 0.5, name: 'olive' },
    Raadsaal:       { pivotx: 0, pivoty : 0, scale: 1.0, name: 'blue' },
    Borge4x4:       { pivotx: 0, pivoty : 0, scale: 0.5, name: 'grey'}
  },
  items: [
    {
    ...
    { id: 4 , type: 'Kos4x4'         , x: 0, y: 0, z: 0, angle: 0, layer: 'base',  group: 2, data: {} },
    { id: 5 , type: 'Kos4x4'         , x: 0, y: 0, z: 0, angle: 0, layer: 'base',  group: 1, data: {} },
    { id: 6 , type: 'Kos4x4'         , x: 0, y: 0, z: 0, angle: 0, layer: 'base',  group: 1, data: {} },
    { id: 7 , type: 'Snuffel4x4'     , x: 0, y: 0, z: 0, angle: 0, layer: 'base',  group: 2, data: {} },
    ...
    { id: 10, type: 'Opvoedkunde4x4' , x: 0, y: 0, z: 0, angle: 0, layer: 'base',  group: 2, data: {} },
    ...
    { id: 13, type: 'Tema4x4'        , x: 0, y: 0, z: 0, angle: 0, layer: 'base',  group: 2, data: {} },
